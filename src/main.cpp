...
void prepArm(void *param)
{
    ...
    while (true)
    {
        ...
        if (currentPosition > 35000.0)
        {
            robotDevices.liftRotation.set_position(100.0);
        }
...
void autonomous()
{
    ...
    case 0:
        ...
        robotDevices.chassis.moveToPose(25.70, -23.26, -74.6, 4000);
        ...
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(soloblue22_txt, 15, 3000, false);
        robotDevices.chassis.waitUntilDone();
        robotDevices.mogoClampPiston.set_value(false);
        delay(350);
        ...
        c::motor_move(5, -127);
        c::motor_move(18, -127);
        robotDevices.chassis.follow(soloblue4_txt, 20, 4000, true);

        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.swingToHeading(30, DriveSide::RIGHT, 1000);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(soloblue55_txt, 20, 4000, true);
        robotDevices.chassis.waitUntilDone();

        /*
        robotDevices.chassis.waitUntilDone();
        delay(200);
        robotDevices.chassis.follow(soloblue5_txt, 20, 4000, false);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.turnToHeading(10, 800);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(soloblue6_txt, 20, 4000, true);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.swingToHeading(200, DriveSide::RIGHT, 600);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.swingToHeading(170, DriveSide::RIGHT, 1000);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(soloblue7_txt, 20, 4000, true);
        ...
        robotDevices.mogoClampPiston.set_value(true);
        delay(400);
        robotDevices.chassis.follow(soloblue8_txt, 20, 4000, true);
        robotDevices.chassis.waitUntilDone();
        delay(275);
        c::motor_move(5, -5);
        c::motor_move(18, -5);
        ...
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(soloblue9_txt, 20, 1500, false);
        robotDevices.chassis.waitUntilDone();
        robotDevices.mogoClampPiston.set_value(false);
        delay(100);
        ...
        c::motor_move(5, -127);
        c::motor_move(18, -127);
        robotDevices.chassis.follow(soloblue10_txt, 20, 1500, true);
        robotDevices.chassis.waitUntilDone();
        ...
        robotDevices.chassis.follow(soloblue11_txt, 20, 1500, false);
*/
        break;
    case 1:
        robotDevices.frontLeftMotor.set_brake_mode(E_MOTOR_BRAKE_HOLD);
        ...
        robotDevices.upperRightMotor.set_brake_mode(E_MOTOR_BRAKE_HOLD);
        robotDevices.lowerRightMotor.set_brake_mode(E_MOTOR_BRAKE_HOLD);
        robotDevices.chassis.setPose(-49.659, -36.429, 110);
        c::motor_move(5, -127);
        robotDevices.chassis.follow(redrush1_txt, 20, 2000, true);
        robotDevices.chassis.waitUntilDone();
        robotDevices.doinker.set_value(true);
        delay(250);
        robotDevices.chassis.follow(redrush2_txt, 20, 15000, false);
        robotDevices.chassis.waitUntilDone();
        robotDevices.doinker.set_value(false);
        delay(250);
        robotDevices.chassis.turnToHeading(279, 700);
        robotDevices.chassis.waitUntilDone();
        robotDevices.mogoClampPiston.set_value(true);
        robotDevices.chassis.follow(redrush3_txt, 20, 2000, false);
        robotDevices.chassis.waitUntilDone();
        robotDevices.mogoClampPiston.set_value(false);
        delay(300);
        c::motor_move(5, -127);
        ...
        c::motor_move(5, 0);
        c::motor_move(18, 0);
        robotDevices.chassis.follow(redrush44_txt, 10, 2000, false);
        robotDevices.chassis.waitUntilDone();
        // delay(400);
        robotDevices.mogoClampPiston.set_value(false);
        delay(250);
        ...
        robotDevices.chassis.follow(redrush555_txt, 10, 2000, true);
        c::motor_move(5, -127);
        c::motor_move(18, -127);
        robotDevices.chassis.waitUntilDone();
        delay(100);
        ...
        delay(200);
        robotDevices.chassis.turnToHeading(210, 700);
        robotDevices.chassis.waitUntilDone();

        c::motor_move(5, 0);

        robotDevices.chassis.follow(redrush66_txt, 10, 2000, true);
        robotDevices.chassis.waitUntilDone();
    ...
    case 2:
        ...
        robotDevices.upperRightMotor.set_brake_mode(E_MOTOR_BRAKE_HOLD);
        robotDevices.lowerRightMotor.set_brake_mode(E_MOTOR_BRAKE_HOLD);
        robotDevices.chassis.setPose(-62.967, 7.91, 195);
        c::motor_move(17, -127);
        delay(400);
        c::motor_move(17, 127);
        delay(500);
        ...
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(solored22_txt, 15, 3000, false);
        robotDevices.chassis.waitUntilDone();
        robotDevices.mogoClampPiston.set_value(false);
        delay(350);
        robotDevices.chassis.turnToHeading(35, 800);
        robotDevices.chassis.waitUntilDone();
        c::motor_move(5, -127);
        c::motor_move(18, -127);
        robotDevices.chassis.follow(solored4_txt, 20, 4000, true);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.swingToHeading(0, DriveSide::LEFT, 1000);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(solored55_txt, 20, 4000, true);
        robotDevices.chassis.waitUntilDone();

        robotDevices.chassis.turnToHeading(235, 1000);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(solored66_txt, 20, 4000, true);
        robotDevices.chassis.waitUntilDone();

        robotDevices.chassis.turnToHeading(325, 800);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(solored77_txt, 20, 4000, true);
    ...
    case 3:
        ...
        robotDevices.upperRightMotor.set_brake_mode(E_MOTOR_BRAKE_HOLD);
        robotDevices.lowerRightMotor.set_brake_mode(E_MOTOR_BRAKE_HOLD);
        robotDevices.chassis.setPose(48.08, -57.466, 290);

        robotDevices.chassis.follow(bluerush1_txt, 15, 2000, true);
        c::motor_move(5, -127);
        robotDevices.chassis.waitUntilDone();
        robotDevices.doinker.set_value(true);

        delay(100);
        robotDevices.chassis.follow(bluerush2_txt, 15, 15000, false);
        robotDevices.chassis.waitUntilDone();
        robotDevices.doinker.set_value(false);
        delay(250);
        ...
        robotDevices.chassis.waitUntilDone();
        robotDevices.mogoClampPiston.set_value(true);
        robotDevices.chassis.follow(bluerush3_txt, 15, 1000, false);
        robotDevices.chassis.waitUntilDone();
        robotDevices.mogoClampPiston.set_value(false);
        delay(500);
        c::motor_move(5, -127);
        ...
        robotDevices.chassis.follow(bluerush44_txt, 15, 1000, false);
        robotDevices.chassis.waitUntilDone();

        robotDevices.mogoClampPiston.set_value(false);
        robotDevices.chassis.turnToHeading(40, 1000);
        robotDevices.chassis.waitUntilDone();
        robotDevices.ringStopperPiston.set_value(true);
...
/*
    ...
    case 4:
        ...
        robotDevices.upperRightMotor.set_brake_mode(E_MOTOR_BRAKE_HOLD);
        robotDevices.lowerRightMotor.set_brake_mode(E_MOTOR_BRAKE_HOLD);
        robotDevices.chassis.setPose(-60, 0, 270);
        ...
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.turnToHeading(359, 700);
        robotDevices.chassis.waitUntilDone();
        ...
        robotDevices.chassis.waitUntilDone();
        startPrepArmTask();
        robotDevices.chassis.turnToHeading(173, 700);
        robotDevices.chassis.waitUntilDone();
        ...
        robotDevices.chassis.turnToHeading(150, 700);
        robotDevices.chassis.waitUntilDone();
        ...
        robotDevices.chassis.follow(skills11_txt, 20, 4000, true);
        robotDevices.chassis.waitUntilDone();
        c::motor_move(5, 0);
        c::motor_move(18, 0);
        robotDevices.chassis.turnToHeading(177, 700);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(skills12_txt, 20, 6000, false);
        robotDevices.chassis.waitUntilDone();
        // delay(300);
        robotDevices.mogoClampPiston.set_value(false);
        delay(300);
        ...
        robotDevices.chassis.turnToHeading(40, 700);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(skills14_txt, 20, 6000, true);
        robotDevices.chassis.waitUntilDone();
        delay(1000);
        ...
        startPrepArmTask();
        delay(100);
        robotDevices.chassis.follow(skills16_txt, 20, 2000, true);
        robotDevices.chassis.waitUntilDone();
        delay(1200);
        c::motor_move(5, 15);
        c::motor_move(18, 15);
        ...
        delay(1200);
        c::motor_move(17, 0);
        robotDevices.chassis.turnToHeading(250, 700);
        robotDevices.chassis.waitUntilDone();
        c::motor_move(5, -127);
        c::motor_move(18, -127);
        robotDevices.chassis.follow(skills18_txt, 20, 3000, true);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.turnToHeading(37, 700);
        robotDevices.chassis.follow(skills19_txt, 20, 3000, true);
        robotDevices.chassis.waitUntilDone();
        delay(500);

        robotDevices.chassis.swingToHeading(170, DriveSide::LEFT, 1000);
        robotDevices.chassis.waitUntilDone();
        robotDevices.mogoClampPiston.set_value(true);
        c::motor_move(5, 15);
        c::motor_move(18, 15);
        ...
        robotDevices.chassis.turnToHeading(90, 700);
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.follow(skills22_txt, 30, 3000, true);
        /*
        robotDevices.chassis.waitUntilDone();
        robotDevices.chassis.turnToHeading(130, 700);
        robotDevices.chassis.waitUntilDone();

        robotDevices.chassis.follow(skills23_txt, 20, 3000, true);
        robotDevices.chassis.waitUntilDone();
        */
